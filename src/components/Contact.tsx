  ...
  return (
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto" ref={ref}>
        ...
        >
          Open to AI architecture, engineering leadership, or interesting collaboration.
        </motion.p>
        ...
        <motion.p
          ...
          className="mt-16 pt-8 border-t border-card-border text-xs text-muted-foreground font-mono"
        >
          © {new Date().getFullYear()} Arjun K Dasgupta
        </motion.p>
      </div>
    </section>
  );
