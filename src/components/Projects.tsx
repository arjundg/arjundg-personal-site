        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="bg-card border border-card-border rounded-xl overflow-hidden hover:border-accent/50 transition-all group"
            >
              {/* Visual header */}
              <div className={`h-32 bg-gradient-to-br ${project.gradient} flex items-center justify-center relative`}>
                ...
                {project.link !== "#" && (
                  <a
                    ...
                    className="absolute top-3 right-3 p-2 bg-background/80 backdrop-blur-sm rounded-lg text-muted-foreground hover:text-accent transition-colors"
